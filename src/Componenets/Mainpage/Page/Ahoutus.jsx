...
import subadount from './../../../assets/images/about_us/person.jpeg'
const Ahoutus = () => {
    return (
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row p-5">
                <div className='flex-1 p-5 relative'>
                    <img src={about} className=" w-[460px] h-[473px] bg-cover rounded-lg shadow-2xl flex-1" />
                ...
                <div className='flex-1 mt-10 lg:mt-1'>
                    ...
                    <h1 className="lg:text-5xl text-4xl font-bold text-black">We look at assignments carefully. Marks obtained by them are given</h1>
